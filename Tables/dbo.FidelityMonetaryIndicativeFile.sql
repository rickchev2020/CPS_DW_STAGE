CREATE TABLE [dbo].[FidelityMonetaryIndicativeFile]
(
[FidelityMonetaryIndicativeFileId] [int] NOT NULL IDENTITY(1, 1),
...
GO
ALTER TABLE [dbo].[FidelityMonetaryIndicativeFile] ADD CONSTRAINT [PK__Fidelity__E8E135D5EE250C75] PRIMARY KEY CLUSTERED ([FidelityMonetaryIndicativeFileId]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
